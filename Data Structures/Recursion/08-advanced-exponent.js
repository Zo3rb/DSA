...
function advancedExponent(b, n) {
  ...
  if (n === 0) {
    ...
    // For even n, square the result of advancedExponent(b, n / 2).
    const halfExponent = advancedExponent(b, n / 2);
    return halfExponent * halfExponent;
  } else {
    // For odd n, calculate b * (advancedExponent(b, (n - 1) / 2))^2.
    const halfExponent = advancedExponent(b, (n - 1) / 2);
    return b * halfExponent * halfExponent;
  }
}
